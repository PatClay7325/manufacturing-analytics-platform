...
export const DashboardListPanel: React.FC<PanelProps> = ({ panel, data, height, width }) => {
  return (
    <div
    ...
    >
      <div className="text-center p-4">
        <h3 className="text-lg font-semibold text-gray-700 mb-2">Dashboard List Panel</h3>
