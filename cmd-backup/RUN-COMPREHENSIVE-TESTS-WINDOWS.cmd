...
echo Testing manufacturingPlatform Dashboard page...
curl -s -o nul -w "manufacturingPlatform Dashboard: %%{http_code}\n" http://localhost:3000/manufacturingPlatform-dashboard
