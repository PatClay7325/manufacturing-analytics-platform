...
fix_file "src/components/manufacturingPlatform/ManufacturingPlatformPanel.tsx"
...
fix_file "src/components/layout/ManufacturingPlatformLayout.tsx"
...
fix_file "src/app/dashboards/manufacturingPlatform/page.tsx"
