@echo off
echo ================================================================================
echo    Remove All manufacturingPlatform References from Manufacturing Analytics Platform
echo ================================================================================
echo.
echo This script will comprehensively remove all manufacturingPlatform references and replace
...
echo   - Route paths (/manufacturingPlatform-dashboard → /analytics-dashboard)
...
if "%option%"=="1" (
    ...
    echo ================================================================================
    call npx tsx scripts/remove-manufacturingPlatform-references.ts --dry-run
    echo.
    echo ================================================================================
    ...
    if /i "%confirm%"=="yes" (
        echo.
        echo Removing all manufacturingPlatform references...
        echo ================================================================================
        call npx tsx scripts/remove-manufacturingPlatform-references.ts
        echo.
        echo ================================================================================
        echo.
        echo Next steps:
