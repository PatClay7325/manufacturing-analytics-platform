    ...
    >
          ...
          <div>
            ...
            <div className="flex items-center mb-3">
              <div className="flex items-center text-sm text-gray-500 mr-4">
                {getSourceIcon()}
                <span className="ml-1" data-testid="alert-equipment">{alert?.sourceName || alert?.source}</span>
              </div>
              <span className="text-sm text-gray-500" data-testid="alert-timestamp">
                {getRelativeTime(alert?.createdAt)}
              </span>
            </div>
          </div>
          <div className="flex space-x-2">
            <AlertBadge type="severity" value={alert?.severity} data-testid="alert-severity" />
            <AlertBadge type="status" value={alert?.status} data-testid="alert-status" />
          </div>
        </div>
      ...
      <div className="bg-gray-50 px-5 py-3 border-t border-gray-200 flex justify-between items-center">
        ...
        <div className="flex space-x-2">
          ...
          <button 
            className="text-sm font-medium text-gray-600 hover:text-gray-800 transition"
            data-testid="assign-alert-button"
          >
            Assign
          </button>
        </div>
