...
import { ManufacturingDashboard, GRAFANA_DASHBOARDS } from '@/components/Analytics/ManufacturingDashboard';
...
const dashboardCategories = [
  {
    ...
    name: 'OEE Analysis',
    icon: BarChart3,
    dashboard: GRAFANA_DASHBOARDS.MANUFACTURING_OEE,
    variables: {
      site: 'all',
      equipment_type: 'all'
    }
  },
  {
    ...
    icon: Activity,
    dashboard: GRAFANA_DASHBOARDS.EQUIPMENT_HEALTH,
    variables: {
      equipment_id: 'all',
      severity: 'all'
    }
  },
  {
    ...
    icon: Factory,
    dashboard: GRAFANA_DASHBOARDS.PRODUCTION_METRICS,
    variables: {
      line: 'all',
      shift: 'current'
    }
