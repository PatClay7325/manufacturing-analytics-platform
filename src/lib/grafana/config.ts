...
export const GRAFANA_THEME_CONFIG = {
    ...
    fieldConfig: {
      defaults: {
        ...
        thresholds: {
          ...
          steps: [
            {
              color: GRAFANA_THEME_CONFIG.colors.danger,
              value: null
            },
            {
              color: GRAFANA_THEME_CONFIG.colors.warning,
              value: 60
            },
            {
              color: GRAFANA_THEME_CONFIG.colors.success,
              value: 85
            }
          ]
        },
    ...
    fieldConfig: {
      defaults: {
        ...
        thresholds: {
          ...
          steps: [
            {
              color: GRAFANA_THEME_CONFIG.colors.primary,
              value: null
            }
          ]
        }
