-- ISO 22400 Compliant OEE Metrics View
-- This creates a view that calculates OEE metrics according to ISO 22400 standards
-- Based on the existing PerformanceMetric table in the Prisma schema

-- Drop the view if it exists
DROP VIEW IF EXISTS vw_iso22400_oee_metrics CASCADE;

-- Create the ISO 22400 compliant OEE metrics view
...
-- SELECT * FROM vw_iso22400_oee_metrics LIMIT 10;