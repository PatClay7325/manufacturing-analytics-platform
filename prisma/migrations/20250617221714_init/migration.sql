...
-- CreateIndex
CREATE INDEX "metrics_equipmentId_name_timestamp_idx" ON "metrics"("equipmentId", "name", "timestamp" DESC);
...
-- CreateIndex
CREATE UNIQUE INDEX "dashboards_uid_key" ON "dashboards"("uid");
...
-- CreateIndex
CREATE INDEX "dashboards_tags_idx" ON "dashboards"("tags");
...
-- AddForeignKey
ALTER TABLE "metrics" ADD CONSTRAINT "metrics_equipmentId_fkey" FOREIGN KEY ("equipmentId") REFERENCES "Equipment"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "dashboards" ADD CONSTRAINT "dashboards_createdBy_fkey" FOREIGN KEY ("createdBy") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
